  ...
  return (
    ...
    >
      <div className="w-full flex justify-center items-center">
        <div className="w-full lg:w-[638px] px-4 xl:px-0 flex flex-col gap-3">
      ...
      <div className="container mx-auto 3xl:w-[1087px] relative">
        ...
        <div className="absolute -top-8 left-10 lg:-top-5 xl:-top-18 lg:left-[103px] xl:left-[223px]">
          <Image
            src="/sphare.svg"
            alt="sphare image"
            width={570}
            height={570}
            className="w-full h-[300px] xl:h-[570px] lg:w-[570px] object-cover lg:object-contain"
            priority
          />
        </div>
      </div>
      {/* Feature image */}
      <div className="w-full 2xl:w-[1097px] container mx-auto h-full xl:h-[680px] rounded-[22px] overflow-hidden z-10 px-4 xl:px-0 relative">
        <Image
          src="/videos/ask-vasity.gif"
          alt="Feature image"
          width={1097}
          height={784}
          priority
